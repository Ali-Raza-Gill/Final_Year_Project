        ...
        <ScrollView>
          <View style={[styles.horizantlyCenter,styles.flexContainer, {marginVertical:10}]}>
            ...
            <Surface style={[styles.Box, styles.Box2, styles.radius]} elevation={2}>
              ...
              <View>
                <Surface style={[ styles.Box1, styles.radius,styles.horizantlyCenter,]}>
                  <Text style={[styles.h2, styleclr.secondary1, styles.shadowProp,]} >{orders.length}</Text>
                </Surface>
              </View>
            </Surface>
            <Surface style={[styles.Box, styles.Box3, styles.radius]} elevation={2}>
              ...
              <View>
                <Surface style={[ styles.Box2, styles.radius,styles.horizantlyCenter,]}>
                  <Text style={[styles.h2, styleclr.secondary2, styles.shadowProp,]} >{workers.length}</Text>
                </Surface>
              </View>
            </Surface>
            ...
            <Surface style={[styles.Box, styles.Box3, styles.radius]} elevation={2}>
              ...
              <View >
                <Text style={[ styles.h2, styleclr.secondary2]} > <Icon style={[ styles.h2]}name="renren" /> Categories</Text>
              </View>
              <View>
                <Surface style={[ styles.Box2, styles.radius,styles.horizantlyCenter,]}>
                  <Text style={[styles.h2, styleclr.secondary2, styles.shadowProp,]} >{Categories.length}</Text>
                </Surface>
              </View>
            </Surface>
